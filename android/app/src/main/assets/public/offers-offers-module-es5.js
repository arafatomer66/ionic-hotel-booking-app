...
var routes = [
    ...
    {
        path: 'new-offer',
        loadChildren: function () { return __webpack_require__.e(/*! import() | new-offer-new-offer-module */ "new-offer-new-offer-module").then(__webpack_require__.bind(null, /*! ./new-offer/new-offer.module */ "./src/app/places/offers/new-offer/new-offer.module.ts")).then(function (m) { return m.NewOfferPageModule; }); }
    },
    {
        path: 'edit-offer',
    ...
    {
        path: 'offer-bookings',
        loadChildren: function () { return __webpack_require__.e(/*! import() | offer-bookings-offer-bookings-module */ "common").then(__webpack_require__.bind(null, /*! ./offer-bookings/offer-bookings.module */ "./src/app/places/offers/offer-bookings/offer-bookings.module.ts")).then(function (m) { return m.OfferBookingsPageModule; }); }
    }
];
...
var OffersPage = /** @class */ (function () {
    function OffersPage(placesServices, router) {
